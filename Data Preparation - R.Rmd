...
---
> **Summary**
1. [Tidy Data Concept](#tidy-data)
2. [Dplyr: Select, Filter, Mutate, Summarize](#library-dplyr)
...
```
![](Images/starwars_f.PNG?raw=true)
...
```
![](Images/starwars_nw.PNG?raw=true)
...
```
![](Images/starwars_sz.PNG?raw=true)
...
```
![](Images/starwars_ld.PNG?raw=true)
...
```
![](Images/starwars_td.PNG?raw=true)
